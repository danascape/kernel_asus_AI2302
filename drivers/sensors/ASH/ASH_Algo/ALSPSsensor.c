...
#endif
	log("Proximity show High Calibration: %d\n", g_ps_data->g_ps_calvalue_hi);
	return g_ps_data->g_ps_calvalue_hi;
}
...
#endif
	log("Proximity show Low Calibration: %d\n", g_ps_data->g_ps_calvalue_lo);
	return g_ps_data->g_ps_calvalue_lo;
}
...
static int mproximity_show_calibration_inf(void)
{
	...
	calvalue = psensor_factory_read_inf(PSENSOR_INF_CALIBRATION_FILE);
        g_ps_data->g_ps_calvalue_inf = calvalue;
#endif
	log("Proximity show Inf Calibration: %d\n", g_ps_data->g_ps_calvalue_inf);
	return g_ps_data->g_ps_calvalue_inf;
}
...
static int mproximity_show_calibration_offset(void)
{
	...
	calvalue = psensor_factory_read_inf(PSENSOR_OFFSET_CALIBRATION_FILE);
        g_ps_data->g_ps_calvalue_offset = calvalue;
#endif
	log("Proximity show Offset Calibration: %d\n", g_ps_data->g_ps_calvalue_offset);
	return g_ps_data->g_ps_calvalue_offset;
}
...
#endif
	log("Light Sensor show Calibration: %d\n", g_als_data->g_als_calvalue);
	return g_als_data->g_als_calvalue;
}
