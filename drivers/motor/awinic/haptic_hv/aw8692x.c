...
{
	i2c_w_bits(aw_haptic, AW8692X_REG_SYSCTRL4, (~(1<<0)), flag);
}
#endif
#ifdef ASUS_HAPTIC_PORTING
...
static void aw8692x_misc_para_init(struct aw_haptic *aw_haptic)
{
    ...
    //asus trigger priority setting.  GO bit trigger vibration has the highest priority.
	i2c_w_bytes(aw_haptic, AW8692X_REG_GLBCFG4, &asus_trig_prio,
		    AW_I2C_BYTE_ONE);
#endif
