...
#define QSERDES_TX0_TX_EMP_POST1_LVL      TX_OFF(0, 0x0C)
...
#define QSERDES_TX1_TX_EMP_POST1_LVL      TX_OFF(1, 0x0C)
...
static struct ufs_qcom_phy_calibration phy_cal_table_rate_A_g5[] = {
	...
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_TX0_TX_EMP_POST1_LVL, 0x2E),
	...
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_TX1_TX_EMP_POST1_LVL, 0x2E),
