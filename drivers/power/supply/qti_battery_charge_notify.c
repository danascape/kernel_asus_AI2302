...
void qti_charge_notify_device_wls_charge(void)
{
	blocking_notifier_call_chain(&qti_charge_notifier_list, QTI_POWER_SUPPLY_WLS_CHARGED, NULL);
}
EXPORT_SYMBOL(qti_charge_notify_device_wls_charge);

void qti_charge_notify_device_wls_uncharge(void)
{
	blocking_notifier_call_chain(&qti_charge_notifier_list,	QTI_POWER_SUPPLY_WLS_UNCHARGED, NULL);
}
EXPORT_SYMBOL(qti_charge_notify_device_wls_uncharge);
